<button class="green-button" id="radius_distaalinen_hoito-ohjeet">Hoito-ohjeet</button> <button class="red-button" id="radius_distaalinen_lisatietoa">Lisätietoa</button>
